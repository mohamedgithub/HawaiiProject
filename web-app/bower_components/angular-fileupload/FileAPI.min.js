...
!function(a) {
    ...
    function e(a, e, f, g) {
        if (Y.isBlob(a) && d(f)) {
            ...
            c(a, e, "error", b, {error: "filreader_not_support_" + f})
    }
    function f(a, b) {
    ...
    d.prototype = {image: !0, constructor: d, set: function(b) {
            ...
            for (m -= 360 * Math.floor(m / 360), b._type = this.file.type; i.multipass && e(p / n, q / o) > 2; )
            ...
            if ("preview" == l) {
                ...
                l && (d > h || g > i ? "min" == l ? (h = f(k > j ? e(d, h) : i * j), i = f(k > j ? h / j : e(g, i))) : (h = f(j >= k ? e(d, h) : i * j), i = f(j >= k ? h / j : e(g, i))) : (h = d, i = g));
    ...
    function c(b, c, d) {
        ...
        if (f) {
            if (!e.toDataURL)
                return void a.readAsBinaryString(e, function(a) {
                    ...
                    g.upload && g.upload.addEventListener("progress", b.throttle(function(a) {
                        ...
                        if (h.status = g.status, h.statusText = g.statusText, h.readyState = g.readyState, 4 == g.readyState) {
                            ...
                            if (g.onreadystatechange = null, !g.status || g.status - 201 > 0)
                                ...
                                e.retry = 0, e.end == e.size - 1 ? h.end(g.status) : (b.log("X-Last-Known-Byte: " + a), a && (e.end = a), e.file.FileAPIReadPosition = e.end, setTimeout(function() {
                                    h._send(c, e)
                                }, 0));
                            g = null
                        }
    ...
    c.support.flash = function() {
        ...
        var r = c.uid(), s = 0, t = {}, u = /^https?:/i, v = {_fn: {}, init: function() {
                ...
                c.flashEngine = !0, j(c, {getFiles: function(a, b, d) {
                        if (d)
                            return c.filterFiles(c.getFiles(a), b, d), null;
                        ...
                        if (c.log("FlashAPI.Image._load:", a), k(a))
                            this.parent.apply(this, arguments);
                        else {
                            var d = this;
                        ...
                        if (c.log("FlashAPI.Image._apply:", a), k(a))
                            this.parent.apply(this, arguments);
                        else {
                        ...
                        if (b.nodeName || b.append && c.support.html5 || c.isArray(b) && "string" == typeof b[0])
                            return this.parent.apply(this, arguments);
                        var d, e, f = {}, h = {}, i = this;
                        if (g(b, function(a) {
                            a.file ? (h[a.name] = a = p(a.blob), e = a.id, d = a.flashId) : f[a.name] = a.blob
                        }), e || (d = r), !d)
                            return c.log("[err] FlashAPI._send: flashId -- undefined"), this.parent.apply(this, arguments);
