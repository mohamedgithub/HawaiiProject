...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.az.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.az.UserRole'
grails.plugin.springsecurity.authority.className = 'com.az.Role'
