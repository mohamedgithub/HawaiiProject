        ...
        <div class="col-lg-3 col-xsm-6">
            <div class="panel mini-box">
                ...
                <div class="box-info">
                    ...
                    <p class="text-muted"><span data-i18n="new_users"></span></p>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-xsm-6">
        ...
        <div class="col-md-8">
            <section class="panel panel-default">
                ...
                <div class="panel-body" data-ng-controller="morrisChartCtrl">
                    <div morris-chart data-data="comboData"data-type="bar"data-xkey="year" data-ykeys='["a", "b", "c"]' data-labels='["Value A", "Value B", "Value C"]' data-bar-colors='["#176799","#42A4BB","#78D6C7"]'style="height: 300px;"></div>
                </div>
            </section> 
        </div>
        <div class="col-md-4">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body"  data-ng-controller="flotChartCtrl">
                    <div data-flot-chart data-data="donutChart2.data" data-options="donutChart2.options" style="width: 100%; height: 300px;"></div>                    
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div data-flot-chart-realtime data-type="realtime" style="width: 100%; height: 275px;"></div>                    
                </div>
            </div>        
        </div>
        <div class="col-md-4">
            <section class="panel panel-box">
                ...
                <div class="panel-icon bg-info">
                    ...
                    <canvas ui-weather icon="SNOW" color="#fff" width="70"height="70"></canvas>
                </div>
                <div class="panel-bottom bg-reverse">
                    <ul class="list-justified text-center">
                        <li>
                            <canvas ui-weather icon="RAIN" color="#23AE89" width="40" height="40"></canvas>                            
                            <p class="text-muted">Wednesday</p>
                        </li>
                        <li>
                            <canvas ui-weather icon="WIND" color="#6A55C2" width="40" height="40"></canvas>  
                            <p class="text-muted">Thursday</p>
                        </li>
                        <li>
                            <canvas ui-weather icon="CLEAR_DAY" color="#FFB61C" width="40" height="40"></canvas> 
