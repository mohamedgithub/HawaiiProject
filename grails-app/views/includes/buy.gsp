                    ...
                    <div class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                        <table table class=" table table-hover table table-bordered  table table-striped" > 
                            ...
                            <tr>
                                ...
                                <td><center><input type="number" class="form-control" name="quantity" min="1" max="{{product.quantity}}" ng-model="quantity" style="width: 150px" name="userOrder" required=""></center></td>
                                <td>{{product.sellingPrice * quantity}}</td>
